    ...
    return (
        <>
            ...
            <Typography variant='h5' style={{ textAlign: 'left', paddingBottom: '10px' }}>
                ...
                <a href='mailto: jord_ogrady@hotmail.com'>jord_ogrady@hotmail.com</a>
            </Typography>
            ...
            <section className='center-info'>
                ...
                {messageSent && (
                    <div>
                        <span className='check-img' role='check-img'>✅</span><p className='success-text'>Message sent successfully! I will get back to you shortly!</p>
                    </div>
                )}
            </section>
        </>
